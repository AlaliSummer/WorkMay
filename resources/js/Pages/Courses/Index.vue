        ...
        <div class="container my-3 py-3">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card blur border border-white mb-4 shadow-xs">
                        <div class="card-body p-4">
                            ...
                            <p class="text-sm mb-1">{{ $t('words.eng-courses') }}</p>
                            <h3 class="mb-0 font-weight-bold">{{ $t('words.eng') }}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="card blur border border-white mb-4 shadow-xs">
                        <div class="card-body p-4">
                            ...
                            <p class="text-sm mb-1">{{ $t('words.management-courses') }}</p>
                            <h3 class="mb-0 font-weight-bold">{{ $t('words.management') }}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="card blur border border-white mb-4 shadow-xs">
                        <div class="card-body p-4">
                            ...
                            <p class="text-sm mb-1">{{ $t('words.art-courses') }}</p>
                            <h3 class="mb-0 font-weight-bold">{{ $t('words.art') }}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="card blur border border-white mb-4 shadow-xs">
                        <div class="card-body p-4">
                            ...
                            <p class="text-sm mb-1">{{ $t('words.music-courses') }}</p>
                            <h3 class="mb-0 font-weight-bold">{{ $t('words.music') }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                        ...
                                        <div class="card-body text-start ps-3 pe-2 pt-2 pb-2 w-100">
                                            <div class="row">
                                                <div class="col-8 py-2">
                                                    <p class="text-white text-sm font-weight-bold mb-6">Corporate UI
                                                    </p>
                                                    <div class="d-flex align-items-center mb-0 mt-auto">
                                                        <p class="font-weight-semibold mb-0">Noah Jackes</p>
                                                        <span
                                                            class="ms-auto text-xs font-weight-bolder text-pt-mono">08/28</span>
                                                    </div>
                                                    <span
                                                        class="ms-auto text-sm font-weight-bolder text-pt-mono">1234&nbsp;&nbsp;6578&nbsp;&nbsp;9000&nbsp;&nbsp;1234</span>
                                                </div>
                                                <div class="col-4">
                                                    <div
                                                        class="blur d-flex flex-column w-80 h-100 py-2 ms-auto border-radius-lg border border-white">
                                                        <div class="text-center w-100">
                                                            <img src="/img/header-blue-purple.jpg"
                                    ...
                                    <div class="progress-wrapper w-100 mb-lg-0 mb-5">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-lg bg-gradient-dark w-60"
                                ...
                                <div class="col-lg-5">
                                    <div
                                        ...
                                        <div class="card-body text-start p-2 w-100">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div
                                                        class="blur d-flex align-items-center w-100 border-radius-md border border-white mb-4 p-2">
                                                        <p class="text-white text-sm w-50 mb-0 font-weight-bold">
                                                            Corporate UI</p>
                                                        <div class="text-end ms-auto w-100 pe-2">
                                                            <img src="/img/header-blue-purple.png"
                                    ...
                                    <div class="progress-wrapper w-100">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-lg bg-gradient-dark w-40"
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-4">
                    <ul class="list-group">
                        <li
                            class="list-group-item border-info d-flex justify-content-between mb-3 border-radius-md shadow-xs p-3">
                            <div class="d-flex align-items-start">
                                <div
                                    class="icon icon-shape icon-sm bg-info text-white shadow-none text-center  border-radius-sm me-sm-2 me-3 mt-1 px-2 d-flex align-items-center justify-content-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-sm text-info">Includes 1 user, 10GB individual data and access to
                                        all features.</span>
                                </div>
                            </div>
...
<!--                                           id="customRadioDisabled" class="form-check-input form-check-input-info"-->
<!--                                           checked>-->
<!--                                </div>-->
                            </div>
                        </li>
                        <li
                            class="list-group-item border d-flex justify-content-between mb-3 border-radius-md shadow-xs p-3">
                            <div class="d-flex align-items-start">
                                <div
                                    class="icon icon-shape icon-sm bg-dark text-white shadow-none text-center  border-radius-sm me-sm-2 me-3 mt-1 px-2 d-flex align-items-center justify-content-center">
                                    <svg height="16" width="16" xmlns="http://www.w3.org/2000/svg"
                                         viewBox="0 0 24 24" fill="currentColor">
                                        <path
                                            d="M4.5 6.375a4.125 4.125 0 118.25 0 4.125 4.125 0 01-8.25 0zM14.25 8.625a3.375 3.375 0 116.75 0 3.375 3.375 0 01-6.75 0zM1.5 19.125a7.125 7.125 0 0114.25 0v.003l-.001.119a.75.75 0 01-.363.63 13.067 13.067 0 01-6.761 1.873c-2.472 0-4.786-.684-6.76-1.873a.75.75 0 01-.364-.63l-.001-.122zM17.25 19.128l-.001.144a2.25 2.25 0 01-.233.96 10.088 10.088 0 005.06-1.01.75.75 0 00.42-.643 4.875 4.875 0 00-6.957-4.611 8.586 8.586 0 011.71 5.157v.003z" />
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-sm">Includes up to 10 users, 20GB individual data and access to
                                        all features.</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center text-danger text-gradient">
                        ...
                        <li
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-sm">Includes up to 20 users, 40GB individual data and access to
                                        all features.</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center text-danger text-gradient">
                        ...
                        <li
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-sm">Unlimited users, unlimited individual data and access to all
                                        features.</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center text-danger text-gradient">
