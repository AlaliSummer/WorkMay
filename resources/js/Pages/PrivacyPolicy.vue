...
<template>
    ...
    <div class="mx-5">
        <div dir="ltr" class="mx-auto mt-5" style="max-width:700px;">
            <div class="tw-flex tw-justify-between">
                <div>
                    <Link href="/" class="tw-text-gray-800 hover:text-indigo-500">Home / الرئيسية</Link>
            ...
            <p>This policy applies to all products built and maintained by <a target="_blank" href="https://clarastars.com">Clarastars LLC</a> including Workmay (all versions).</p>
            <h2>What we collect and why</h2>
            <p>Our guiding principle is to collect only what we need. Here’s what that means in practice:</p>
            <h3>Identity &amp; access</h3>
            <p>When you sign up for a Clarastars LLC product, we ask for identifying information such as your name, email address, and maybe a company name. That’s so you can personalize your new account, and we can send you product updates and other essential information. We may also send you optional surveys from time to time to help us understand how you use our products and to make improvements. With your consent, we will send you our newsletter and other updates. We sometimes also give you the option to add a profile picture that displays in our products.</p>
            <p>We will never sell your personal information to third parties, and we won’t use your name or company in marketing statements without your permission either.</p>
            <h3>Billing information</h3>
            <p>If you sign up for a paid Clarastars LLC product, you will be asked to provide your payment information and billing address. Credit card information is submitted directly to our payment processor and doesn’t hit Clarastars LLC servers. We store a record of the payment transaction, including the last 4 digits of the credit card number, for purposes of account history, invoicing, and billing support. We store your billing address so we can charge you for service, calculate any sales tax due, send you invoices, and detect fraudulent credit card transactions. We occasionally use aggregate billing information to guide our marketing efforts.</p>
            <h3>Product interactions</h3>
            <p>We store on our servers the content that you upload or receive or maintain in your Clarastars LLC product accounts. This is so you can use our products as intended, for example, to create vehicle records in Workmay or to receive and send email to your customers using Workmay. We keep this content as long as your account is active. If you delete your account, we’ll delete the content within 60 days.</p>
            <h3>Geolocation data</h3>
            <p>For most of our products, we log the full IP address used to sign up a product account and retain that for use in mitigating future spammy signups. We also log all account access by full IP address for security and fraud prevention purposes, and we keep this login data for as long as your product account is active.</p>
            ...
            <p>When you email Clarastars with a question or to ask for help, we keep that correspondence, including your email address, so that we have a history of past correspondence to reference if you reach out in the future.</p>
            ...
            <p><b>To provide products or services you’ve requested.</b> We use some third-party subprocessors to help run our applications and provide the Services to you. We also use third-party processors for other business functions such as managing newsletter subscriptions, sending customer surveys, and providing our company storefront.</p>
            <p>We may share your information at your direction if you integrate a third-party service into your use of our products. For example, we may allow you, at your option, to connect your Gmail account to your Workmay account so that you can login using your Gmail account.</p>
            ...
            <p><b>To exclude you from seeing our ads.</b> Where permissible by law and if you have a Workmay account, we may share a one-way hash of your email address with ad companies to exclude you from seeing our ads.</p>
            <p><b>To help you troubleshoot or squash a software bug, with your permission.</b>&gt; If at any point we need to access your content to help you with a support case, we will ask for your consent before proceeding.</p>
            <p><b>To investigate, prevent, or take action regarding restricted uses.</b> Accessing a customer’s account when investigating potential abuse is a measure of last resort. We want to protect the privacy and safety of both our customers and the people reporting issues to us, and we do our best to balance those responsibilities throughout the process. If we discover you are using our products for a restricted purpose, we will take action as necessary, including notifying appropriate authorities where warranted.</p>
            <p><b>When required under applicable law.</b></p>
            <p>Clarastars LLC is a Saudi Arabian company and all data infrastructure are located in the Kingdom of Saudi Arabia.</p>
            <ul>
                <li>Requests for user data. Our policy is to not respond to government requests for user data unless we are compelled by legal process or in limited circumstances in the event of an emergency request. However, if Saudi Arabian law enforcement authorities have the necessary warrant, criminal subpoena, or court order requiring us to share data, we must comply. Likewise, we will only respond to requests from government authorities outside the Kingdom of Saudi Arabia if compelled by the Saudi Arabian government through procedures outlined in a mutual legal assistance treaty or agreement. It is Clarastars’ policy to notify affected users before we share data unless we are legally prohibited from doing so, and except in some emergency cases.</li>
                <li>Preservation requests. Similarly, Clarastars’ policy is to comply with requests to preserve data only if compelled by the Saudi Arabian government. We do not share preserved data unless required by law or compelled by a court order that we choose not to appeal. Furthermore, unless we receive a proper warrant, court order, or subpoena before the required preservation period expires, we will destroy any preserved copies of customer data at the end of the preservation period.</li>
            ...
            <p>Finally, if Clarastars LLC is acquired by or merges with another company — we don’t plan on that, but if it happens — we’ll notify you well before any of your personal information is transferred or becomes subject to a different privacy policy.</p>
            ...
            <ul>
                ...
                <li><b>Right to Restrict Processing.</b> This is your right to request restriction of how and why your personal information is used or processed, including opting out of sale of personal information.</li>
            ...
            <p>Many of these rights can be exercised by signing in and updating your account information.</p>
            <p>If you have questions about exercising these rights or need assistance, please contact us at hello@clarastars.com or at Clarastars LLC, Yarmuk, Sahaba Rd, Riyadh, Saudi Arabia. If an authorized agent is corresponding on your behalf, we will need written consent with a signature from the account holder before proceeding.</p>
            ...
            <p>All data is encrypted via <a target="_blank" href="https://en.wikipedia.org/wiki/Transport_Layer_Security">SSL/TLS</a> when transmitted from our servers to your browser. The database backups are also encrypted. In addition, we go to great lengths to secure your data at rest.</p>
            ...
            <p>If you choose to cancel your account, your content will become immediately inaccessible and should be purged from our systems in full within 60 days. This applies both for cases when an account owner directly cancels and for auto-canceled accounts.</p>
            <h2>Location of site and data</h2>
            <p>Our products and other web properties are operated in the Kingdom of Saudi Arabia. If you are located in the European Union, UK, or elsewhere outside of the Kingdom of Saudi Arabia, please be aware that any information you provide to us will be transferred to and stored in the kingdom of Saudi Arabia. By using our websites or Services and/or providing us with your personal information, you consent to this transfer.</p>
            ...
            <p>Have any questions, comments, or concerns about this privacy policy, your data, or your rights with respect to your information? Please get in touch by emailing us at hello@clarastars.com and we’ll be happy to try to answer them!</p>
            <p style="margin: 50px 0px;">Thank you for using Clarastars!</p>
        </div>
    </div>
</template>
