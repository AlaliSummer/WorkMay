...
<template>
    <div class="row">
        <div class="col-12 col-lg-10 mx-auto px-4">
            ...
            <div class="row">
                <div class="col-md-4">
                    <h5 class="font-weight-semibold">معلومات ملفي</h5>
                    <br>
                    <p class="text-sm">يمكنك تحديث معلومات الملف الشخصي لحسابك وعنوان البريد الإلكتروني.</p>
                </div>
                <div class="col-md-8 mb-4">
                    <FormSection  @submitted="updateProfileInformation">
                                <template class="" #form>
                                    <!-- Profile Photo -->
                                    <div v-if="$page.props.jetstream.managesProfilePhotos" class="col-span-6 px-4 sm:col-span-4">
