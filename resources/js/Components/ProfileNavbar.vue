                ...
                <div class="tw-max-w-7xl tw-mx-auto tw-px-4 sm:tw-px-6 lg:tw-px-8">
                    <div class="tw-flex tw-justify-between tw-h-16">
                        <div class="tw-flex">
                            ...
                            <!-- Navigation Links -->
                            <div class="tw-hidden text-white tw-space-x-8 sm:tw--my-px sm:tw-ms-10 sm:tw-flex">
                                <div></div>
                                <NavLink class="text-white" :href="'/'" :active="route().current('home')">
                                    {{ $t('words.home') }}
                                </NavLink>
                                <NavLink class="text-white" :href="'/courses'" :active="route().current('courses.index')">
                                    {{ $t('words.courses') }}
                                </NavLink>
                            </div>
                        </div>
...
<!--                                        </div>-->
                    ...
                    <div class="tw-hidden text-white tw-space-x-8 sm:tw--my-px sm:tw-ms-10 sm:tw-flex pb-1 px-4">
                        <div></div>
